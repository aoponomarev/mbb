// =========================
// УТИЛИТА АВТОМАТИЧЕСКОЙ МАРКИРОВКИ ЭЛЕМЕНТОВ DOM
// Автоматически добавляет классы avto-{hash} к значимым контейнерам
// =========================
// ЦЕЛЬ: Автоматическая маркировка всех значимых контейнеров в DOM для навигации
// в коде через DevTools и указания агенту места в разметке
//
// ПРИНЦИПЫ:
// - Автоматическая маркировка через MutationObserver (работает с асинхронной загрузкой)
// - Исключение элементов внутри Vue компонентов (у них уже есть instanceHash)
// - Маркировка только значимых контейнеров (секции, карточки, контейнеры)
// - Детерминированные хэши на основе пути в DOM
//
// ИСПОЛЬЗОВАНИЕ:

 ...
 *
 * ССЫЛКИ:
 * - Общие принципы маркировки: docs/doc-architect.md (раздел "Маркировка элементов DOM")
 * - Детерминированные хэши компонентов: docs/doc-architect.md (раздел "Детерминированные хэши компонентов")
 */

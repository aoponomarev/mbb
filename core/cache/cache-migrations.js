 ...
 * - Миграции определяются в объекте MIGRATIONS для каждого ключа
 ...
 *
 * ОТЛИЧИЕ ОТ ВЕРСИОНИРОВАНИЯ ПРИЛОЖЕНИЯ:
 * - Версионирование приложения (v:{hash}:{key}) — для данных из внешних API, автоматическая инвалидация
 * - Миграции схем (version в данных) — для пользовательских данных, сохранение данных при изменении структуры
 *

...
5. **Поиск решений в вебе в режиме отладки:** В режиме отладки (debug mode) при решении проблем **ОБЯЗАТЕЛЬНО** используй веб-поиск для расширения поля поиска решений, проверки известных проблем, изучения опыта других разработчиков и сокращения издержек тестирования. Не полагайся только на собственные гипотезы и интуицию — веб-поиск должен использоваться для проверки альтернативных подходов, изучения документации платформ/библиотек, поиска готовых решений и проверки ограничений технологий.

...
12. Rate limiting (`core/api/rate-limiter.js`) — загружается до API-утилит
13. Конфигурация модулей (`core/modules-config.js`)
14. Загрузчик модулей (`core/module-loader.js`) — загружает все скрипты по конфигурации
15. Инициализация приложения (`app/app-ui-root.js`)

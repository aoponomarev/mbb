 ...
 * ================================================================================================
 *
 * ЦЕЛЬ: Интеграция формы портфеля с системой управления кнопками модального окна.
 *
 * ОСОБЕННОСТИ:
 * - Форма для создания/редактирования портфеля (название, описание, активы)
 * - Регистрирует кнопки "Отмена" и "Сохранить"/"Создать" через modalApi
